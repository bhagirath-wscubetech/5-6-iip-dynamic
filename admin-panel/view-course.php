                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <!-- -->
                                            <img style="padding:15px;width:100px;background-color: <?php echo $data['color'] ?>;" src="../images/courses/<?php echo $data['image_name']; ?> " alt="" width="200">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            if ($data['status'] == 1) :
                                            ?>
                                                <a href="view-course.php?id=<?php echo $data['id'] ?>&status=0">
                                                    <button class="btn btn-success">Active</button>
                                                </a>
                                            <?php
                                            else :
                                            ?>
                                                <a href="view-course.php?id=<?php echo $data['id'] ?>&status=1">
                                        ...
                                        <td>
                                            <a href="view-course.php?id=<?php echo $data['id'] ?>">
                                                <!-- get request -->
                                                <button class="btn btn-danger">
                                                    <i class="fa fa-trash"></i>
                                                </button>
                                            </a>
                                            <a href="add-course.php?id=<?php echo $data['id'] ?>">
                                                <button class="btn btn-primary">
