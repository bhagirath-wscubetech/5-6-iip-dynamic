        ...
        <article class="card-body mx-auto" style="min-width: 600px;">
            ...
            <form method="post" id="registration_form">
                ...
                <div class="form-group">
                    <button id="submut_btn" name="submit" type="submit" class="btn btn-primary"> Login Account </button>
                    <a href="forgot-password.php">
                        <button id="submut_btn" name="button" type="button" class="btn btn-primary"> Forgot Password? </button>
                    </a>
                </div> <!-- form-group// -->
